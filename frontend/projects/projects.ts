...
export const projects: Project[] = [
    ...
    },
    {
        title: 'faucet',
        description:
            'You will build a SOL faucet that you will use to fund your Phantom browser wallet.',
        href: {
    ...
    },
    {
        title: 'serialize',
        description:
            'Using Borsh, you will serialize custom instruction data to interact with an existing Solana smart contract.',
        href: {
    ...
    },
    {
        title: 'nft minter',
        description:
            'Create an compressed NFT minting machine using Helius APIs.',
        href: {
    ...
    },
    {
        title: 'movies',
        description:
            'You will write and deploy a Solana program which buffer byte data. You will then create a UI to interact with it.',
        href: {
    ...
    },
    {
        ...
        description:
            'You will use the Helius transaction parser API to view the transaction history of your wallet.',
        href: {
